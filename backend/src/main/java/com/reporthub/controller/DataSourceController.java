...
public class DataSourceController {
    ...
    @PreAuthorize("hasAuthority('menu:datasource:view')")
    public R<List<com.reporthub.datasource.DataSourceAdapter.TableMeta>> getTables(
    ...
    @PreAuthorize("hasAuthority('menu:datasource:view')")
    public R<List<com.reporthub.datasource.DataSourceAdapter.ColumnMeta>> getColumns(
